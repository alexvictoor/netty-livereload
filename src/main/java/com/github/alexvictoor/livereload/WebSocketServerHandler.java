...
public class WebSocketServerHandler extends SimpleChannelInboundHandler<Object> {
    ...
    public static final String HELLO_MSG = "{\"command\":\"hello\",\"protocols\":[\"http:\\/\\/livereload.com\\/protocols\\/official-7\"],\"serverName\":\"netty-livereload\"}";

    private final ChannelGroup allChannels;
    private final String jsContent;
    private WebSocketServerHandshaker handshaker;

    public WebSocketServerHandler(ChannelGroup allChannels, String jsContent) {
    ...
    private void handleWebSocketFrame(ChannelHandlerContext ctx, WebSocketFrame frame) {
        ...
        if (request.contains("hello")) {
            logger.info("Saying hello back");
            ctx.channel().write(new TextWebSocketFrame(HELLO_MSG));
        }
    }
